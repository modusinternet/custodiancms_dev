...
<html lang="en">
	...
	<body>
		...
		<div class="tabs">
			<button class="tab" id="tab01title" onclick="openTab(event,'tab01txt01')"></button>
			<button class="tab" id="tab02title" onclick="openTab(event,'tab02txt01')"></button>
			<button class="tab" id="tab03title" onclick="openTab(event,'tab03txt01')"></button>
			<button class="tab" id="tab04title" onclick="openTab(event,'tab04txt01')"></button>
			<button class="tab" onclick="openTab(event,'tab05txt01')" style="padding:12px 5px 7px 5px;right: 18px;position:absolute">
		...
		<div id="tab01txt01" class="tabcontent"></div>

		<div id="tab02txt01" class="tabcontent"></div>

		<div id="tab03txt01" class="tabcontent"></div>

		<div id="tab04txt01" class="tabcontent"></div>

		<div id="tab05txt01" class="tabcontent"></div>
