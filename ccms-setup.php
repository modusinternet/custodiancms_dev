...
/*
The branch that's being deployed. Must be present in the remote repository.
@var string
*/
define('BRANCH', 'master');

/*
The location that the code is going to be deployed to. Don't forget the trailing slash!
@var string Full path including the trailing slash
*/
define('TARGET_DIR', getcwd() . '/');

/*
Whether to delete the files that are not in the repository but are on the local (server) machine. !!! WARNING !!! This can lead to a serious loss of data if you're not careful. All files that are not in the repository are going to be deleted, except the ones defined in EXCLUDE section. BE CAREFUL!
@var boolean
*/
...
@var boolean Whether to use composer or not @link http://getcomposer.org/
*/
					...
					xhr.onreadystatechange = function(){
						if(xhr.readyState === 4){
							if(xhr.status === 200){
								...
								for(const [key, value] of respJson) {
									console.log("key="+key+"\n");
